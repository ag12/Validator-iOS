...
- (void)viewDidLoad
{
    ...
    self.validations = @[@"^[a-zæåøA-ZÆØÅ]{3,10}$",  // Norwegian First name
                         @"^[a-z]$",        // Middle initial
                         @"^[a-z']{2,10}$", // Last name
    ...
    NSLog(@"%@",[AMValidator stringTrimmedForWhiteSpaces:@"            amir                 er o           k     "]);




    NSLog(@"%@", @([self validateString:[AMValidator stringTrimmedForWhiteSpaces:@"            æææææøøå     "] withPattern:@"^[a-zæåøA-ZÆØÅ]{3,10}$"]));
...
- (NSString *)stringTrimmedForLeadingAndTrailingWhiteSpacesFromString:(NSString *)string
{
    ...
    return [AMValidator stringTrimmedForWhiteSpaces:string];
...
- (BOOL)validateString:(NSString *)string withPattern:(NSString *)pattern
{
    ...
    return [AMValidator validateString:string withPattern:pattern];
}
